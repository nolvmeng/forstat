    ...
    <!-- left side start-->
		...
		<!-- //header-ends -->
					...
					<div id="page-wrapper">
									...
									<div class="graphs">
									<h3 class="blank1">新增货品</h3>
									<div class="tab-content">
									<form class="form-horizontal" action="GoodServlet?method=addGood" method="post">
								
									<div class="form-group">
									<label for="idinput" class="col-sm-2 control-label">货品编号：</label>
									<div class="col-sm-8">
										<input type="text" class="form-control1" id="idinput" placeholder="输入货品ID" name="goodId">
									</div>
									</div>
									<div class="form-group">
									<label for="nameinput" class="col-sm-2 control-label">货品名称：</label>
									<div class="col-sm-8">
										<input  type="text" class="form-control1" id="nameinput" placeholder="输入货品名称" name="goodName">
									</div>
								</div>
								<div class="form-group">
									<label for="addressinput" class="col-sm-2 control-label">货品单价：</label>
									<div class="col-sm-8">
										<input  type="text" class="form-control1" id="addressinput" placeholder="输入货品单价" name="goodPrice">
									</div>
								</div>
								<div class="form-group">
									<label for="phoneinput" class="col-sm-2 control-label">货品数量：</label>
									<div class="col-sm-8">
										<input  type="text" class="form-control1" id="phoneinput" placeholder="输入货品数量" name="goodNum">
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-sm-8">
										<select  class="form-control1" name="slCategory">
										    <option selected>请选择食品类别</option>
